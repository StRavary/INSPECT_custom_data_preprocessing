...
----
  ...
  5 · Timeline      Per-study swimlane view and cohort-wide trajectory heatmap
...
Companion modules
-----------------
  appd_figures.py   — Plotly figure builders (timeline, heatmap, bubble chart)
  appd_export.py    — Long-format/flat-array export helpers and concept-map caches
  appd_route_b_labs.py  — Core DuckDB extraction engine
  appd_route_b_worker.py — Subprocess worker spawned by Tab 2
  appd_clinical_panels.py — Code → clinical panel taxonomy for Tab 5
  appd_context_descriptors.py — Cohort slice descriptors for Tab 3
"""
...
# Plotly figure builders — see appd_figures.py
from Custom.appd_figures import (
    _TRAJECTORY_METRIC_LABELS,
    _build_timeline_figure,
    _build_cohort_trajectory_heatmap,
    _build_cohort_bubble_timeline,
)

# Export / long-format helpers — see appd_export.py
from Custom.appd_export import (
    _STREAM_CHUNK_CELLS,
    _export_subdir,
    _load_concept_map_cached,
    _load_concept_id_map_cached,
    _load_concept_vocab_map_cached,
    _build_long_df,
    _build_long_df_streamed,
    _do_export,
)
